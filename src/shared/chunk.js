...
class Chunk {
  ...
  dispose() {
    if (this._buffers) {
      if (this._buffers.geometry) {
        this._buffers.geometry.dispose();
      }
      if (this._buffers.selectables) {
        this._buffers.selectables.dispose();
      }
      if (this._buffers.studs) {
        this._buffers.studs.dispose();
      }
      this._buffers = null;
    }
  }
